...
class PartnerManagerController extends Controller
{
    public function __construct(){
    	$this->middleware( ['PartnerManager' , 'deactive'] );
    }

    /*Dashboard-Asad:start*/
    public function index(){
    	$projectInstances = $this->getAssignedProjectInstancesForPartnerManager();
        return view('partnerManager/index',['project_instances'=>$projectInstances]);
    }
    //End-->
    ...
    public function viewProfile($user_id)
    {
        ...
        if(!empty($userData)){
            ...
            $userData = $userData[0];
            return view('partnerManager/viewProfile' , ['userAssignedRoles'=> $userRoles,'userData'=>$userData,'user_id'=>$user_id]);            
        }
        else{
            abort(404);
        }
...
/*Manage Project Instance*/
    ...
    public function viewProjectInstanceDetail($projectInstanceId){
        ...
        return view('partnerManager/viewProjectInstanceDetail' ,['project_instance_detail'=>$data ]);
    }
    //End-->
    ...
    public function viewAssignedProjectInstances(){
        ...
        return view('partnerManager/viewAssignedProjectInstances',['project_instances'=>$projectInstances]);
    }
    //End-->

    /*General Function To Get Assigned Instances For Partner-Asad:start*/
    public function getAssignedProjectInstancesForPartnerManager($projectInstanceId=null){
    ...
    public function viewAssignedProjectInstanceDetail($projectInstanceId=null){
        ...
        $projectInstances = $this->getAssignedProjectInstancesForPartnerManager($projectInstanceId);
        
        return view('partnerManager/viewAssignedProjectInstanceDetail',['project_instance'=>$projectInstances,'projectInstanceId'=>$projectInstanceId]);
    }
    //End-->
...
/*Manage Document Template Submissions*/
    ...
    {    
        ...
        return view('partnerManager/submitDocumentTemplate',$data);
    }
    /*Submit Document Template (Get Project Instance Detail & Project Instance All Document Templates)*/
    ...
    public function loadProjectInstanceDocumentTemplateSectionQuestions($project_instance_document_template_id)
    {
        ...
        $data = array(
            ...
            return view('partnerManager/includes/loadProjectInstanceDocumentTemplateForSubmissionContent',$data);
    }
    /* Get Document Template Section Questions)*/
    ...
    {
        return view('partnerManager/includes/loadFileAttachmentControlContent');
    }
    /*Get Media File Attachment Control Content*/
    ...
    public function deleteProjectInstanceSubmissionAttachment(Request $request)
    {
        ...
        if($delete)
        {
            ...
            return view('partnerManager/includes/loadFileAttachmentControlContent',$data);            
        }
    }
    /*Delete Project Instance Submission Attachment File*/
