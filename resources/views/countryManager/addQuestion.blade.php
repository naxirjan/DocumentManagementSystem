...
<script type="text/javascript">
    ...
    {   
        ...
        if(length==0)
        {
            $( "#load_question_meta_section" ).load( "/countryManager/loadQuestionMetaControlContent" );
        }
        else
        {   
