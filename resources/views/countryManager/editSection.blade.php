...
<div class="row">
	<div class="col-sm-12">
		{!! Form::open(array('url'=>'countryManager/updateSection', 'method'=>'POST' , 'class'=>'form-horizontal' , 'id'=>'section-form')) !!}
		<div>
	        	...
	        	if(section_title && section_description && $('ul#section-questions li').length>=1)
	          	{
	          		...
	          		/*jQuery Ajax*/
	                $.ajax({
		                url:"{{url('countryManager/updateSection')}}",
		                type:"POST",
		                dataType: 'json',
		                beforeSend:function(){
		                	$('#div-btn').hide();
			                ...
			                success:function(data){
			                	...
			                	if(data.message == 'Yes'){
			                		...
			                		setTimeout(function(){
			                			...
			                			$('#div-btn').show();
			                			window.location.href = "{{url('countryManager/viewSectionDetail')}}/"+section_id;
			                		},3000);
			                	}else{
			                		$('#div-message>#loading').hide();
			                		...
			                		setTimeout(function(){
			                			$('#div-message>#error-message-not').hide();
			                			$('#div-btn').show();
			                			window.location.href = "{{url('countryManager/viewSection')}}";
			                		},3000);
			                	}
			                }             
	                });
