...
<div class="row">
    <div class="col-md-2"></div>
     <div class="col-md-8">   
         ...
         {!!Form::open(array("url"=>"/countryManager/addOrUpdateQuestionProcess","method"=>"post","class"=>"form-horizontal","role"=>"form", "name"=>"addQuestionForm", "id"=>"addQuestionForm", "enctype"=>"multipart/form-data"))!!}
        ...
        <div class="form-group">
            <label class="col-sm-5 control-label no-padding-right" for="district_operation"></label>
            <div class="col-sm-7">
                ...
                <a href="/countryManager/viewQuestions" class="btn">Cancel</a>
                <br /><br />
                <div id="msg_remove_question_meta">
                </div>
            </div>
...
{           
        ...
        $("#question_type_id").change(function(){
            ...
            {            
               $( "#load_question_meta_section" ).load( "/countryManager/loadQuestionMetaDataByQuestionID/"+question_id);
        ...
        {   
            /*jQuery Ajax*/
                $.ajax({
                url:'/countryManager/deleteQuestionMeta',
                type:"POST",
                data:{
                    _token:'{{csrf_token()}}',
                ...
                success:function(message)
                {
                    if(message=='success')
                    {
                        $( "#load_question_meta_section" ).load( "/countryManager/loadQuestionMetaDataByQuestionID/"+$("#get_question_id").html());
                        $("#msg_remove_question_meta").html('<p class="badge badge-success">Question Item Deleted Successfully !...</p>');
                    }
                    else
                    {
                        $("#msg_remove_question_meta").html('<p class="badge badge-danger">Some Error Occured, Please Try Again Later !...</p>');
                ...
                setTimeout(function(){ $("#msg_remove_question_meta").html(''); }, 4000);
