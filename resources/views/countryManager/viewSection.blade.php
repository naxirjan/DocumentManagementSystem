					...
					<tr>
						...
						<td class="text-center">
							<div class="hidden-sm hidden-xs action-buttons">
								<a title="View Section Detail" target="_blank" class="green" href="{{url('countryManager/viewSectionDetail').'/'.$section->section_id}}">
									<i class="ace-icon fa fa-search-plus bigger-150"></i>
								</a>

								<a title="Edit Section" target="_blank" class="red" href="{{url('countryManager/editSection').'/'.$section->section_id}}">
							...
							<div class="hidden-md hidden-lg">
								<div class="inline pos-rel">
									...
									<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
										<li>
											<a target="_blank" href="{{url('countryManager/viewSectionDetail').'/'.$section->section_id}}" class="tooltip-info" data-rel="tooltip" title="View Section Detail">
												<span class="green">
										...
										<li>
											<a target="_blank" href="{{url('countryManager/editSection').'/'.$section->section_id}}" class="tooltip-success" data-rel="tooltip" title="Edit Section">
												<span class="red">
