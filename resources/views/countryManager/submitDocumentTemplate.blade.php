...
{!!Form::open(array("url"=>"/countryManager/submitDocumentTemplateProcess","method"=>"post","role"=>"form", "name"=>"submitDocumentTemplateProcess", "id"=>"submitDocumentTemplateProcess", "enctype"=>"multipart/form-data"))!!}
<div class="row">
   ...
   /*Document Templates Dropdown onChange*/
    $("#select_box_project_instance_document_template").change(function()
    {
        ...
        $("#project_instance_document_template_id").val(project_instance_document_template_id);
            /*jQuery Ajax*/
            $.ajax({
                url:'/countryManager/loadProjectInstanceDocumentTemplateSectionQuestions/'+project_instance_document_template_id,
                type:"POST",
                data:{
                    _token:'{{csrf_token()}}',
                    },
    ...
    /*Remove Old File Attachment Control*/
     ...
     /*Dialog Box Delete Old File Attachment*/
        $("#btn-delete-project_instance_submission_attachment").click(function(e)
        {
            ...
            /*jQuery Ajax*/
            $.ajax({
                url:'/countryManager/deleteProjectInstanceSubmissionAttachment',
                type:"POST",
                data:{
                    _token:'{{csrf_token()}}',
    ...
    {
        $.get("/countryManager/loadFileAttachmentControlContent", function( content ) 
        {
