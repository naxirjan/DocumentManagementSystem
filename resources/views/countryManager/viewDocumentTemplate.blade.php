					...
					<tr>
						...
						<td class="text-center">
							<div class="hidden-sm hidden-xs action-buttons">
								<a title="View Document Template Detail" target="_blank" class="green" href="{{url('countryManager/viewTemplateDetail').'/'.$template->document_template_id}}">
							...
							<div class="hidden-md hidden-lg">
								<div class="inline pos-rel">
									...
									<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
										<li>
											<a target="_blank" href="{{url('countryManager/viewTemplateDetail').'/'.$template->document_template_id}}" class="tooltip-info" data-rel="tooltip" title="View Document Template Detail">
												<span class="green">
