            ...
            <tbody>
                    @forelse($project_instances['project_instance'] as $project_instance)
                        ...
                        <div class="hidden-sm hidden-xs action-buttons">
                            <a title="View Detail" class="green" href="{{url('countryManager/viewAssignedProjectInstanceDetail').'/'.$project_instance['project_instance_id']}}">
                                <i class="ace-icon fa fa-search-plus bigger-150"></i>
                            </a>
                            <a title="Submit Document Templates" class="red" href="{{url('countryManager/submitDocumentTemplate').'/'.$project_instance['project_instance_id']}}">
                            ...
                            <div class="inline pos-rel">
                                ...
                                <ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
                                    <li>
                                        ...
                                        <a href="{{url('countryManager/submitDocumentTemplate').'/'.$project_instance['project_instance_id']}}" class="tooltip-info" data-rel="tooltip" title="View">
                                            <span class="red">
