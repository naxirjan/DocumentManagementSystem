...
?>
<div style="padding:10px;border-radius:10px;border:1px solid #c7c3c3;" class="document_template_already_exists" document_template_id="{{$document_template_id}}" template_type_id="{{$template_type_id}}">
    <!--Project-->
