...
@section('breadcrumb-section')
	...
	<li class="active">Country Dashboard</li>
	@endsection
...
<h1>
	Country Manager Dashboard <span class="label label-lg label-primary arrowed-in-right arrowed-in">
		<i class="ace-icon fa fa-circle light-green bigger-10"></i> {{ strtoupper(Session::get('current_cont_name')) }}</span>
	<!-- <small>
		...
		<div class="col-xs-6 col-sm-4 col-md-4 pricing-box">
			<div class="widget-box widget-color-blue">
				...
				<div class="widget-body">
					...
					<div>
						<a href="{{url('countryManager/submitDocumentTemplate').'/'.$project_instance_id}}" class="btn btn-block btn-primary">
