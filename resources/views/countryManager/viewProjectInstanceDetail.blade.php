    ...
    <div class="col-md-8">
        <div class="form-horizontal">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    ...
                    <?php
                        ...
                        $project_id = $project_instance_detail['project_instance'][$project_instance_id]['project_id'];
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <label class="">
                        {{ $project_instance_detail['project_instance'][$project_instance_id]['project_instance_description'] }}
                    </label>    
    			</div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <label class="">
                            {{ date('F, Y',strtotime($project_instance_detail['project_instance'][$project_instance_id]['start_date'])) }}
                    </label>    
            </div>
            </div>    
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <label class="">
                        {{ date('F, Y',strtotime($project_instance_detail['project_instance'][$project_instance_id]['end_date'])) }}
                    </label>    
                </div>
            </div>    
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <label class="">
                        {{$project_instance_detail['project_instance'][$project_instance_id]['project_instance_title'] }}
                    </label>    
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <label class="">
                       @php 
                        $role_user_id =    $project_instance_detail['project_instance'][$project_instance_id]['added_by'];
            ...
            <div class="form-group">
                ...
                <?php 
                /*Status*/ 
                if($project_instance_detail['project_instance'][$project_instance_id]['status']=='Active')
                {
                    ?>
                    <div class="col-sm-6">
                        <label class="">
...
<div class="row">
    ...
    <div class="col-md-4">
        ...
        <br />
        <a href="/countryManager/viewProjectInstances" class="btn">Back</a>
