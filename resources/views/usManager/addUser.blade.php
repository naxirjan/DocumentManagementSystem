...
@section('page-content')
	...
	@if($form_action == '/updateUserByusManager')
	<div class = "col-md-12">
		<h4>User Roles</h4>
		<hr />
	</div>
    ...
    <div class = "row" id = "parent_<?php echo $x; ?>">
        ...
        <div class = "col-md-4 districtOperationDiv">
            @if(isset($roles_selected['district_operation_id']))
                ...
                @if($roles_selected['role_id'] ==3 && $roles_selected['country_id'])
...
<div class = "row" id = "parent_1">
	...
	<div class = "row">
		...
		<div class = "col-sm-4">
			...
			@if($form_action == '/updateUserByusManager')
				<a href = "/usManager/viewUsers" class = "btn btn-secondary"> Back</a>
			@else	
	...
	jQuery(function($) {
		...
		$(document).on('change','#country',function(){
			...
			if(country != 0){
				...
				$.ajax({
					url:'/getDistrictOperationByCountryId',
					type:'POST',
...
/*	var row_counter = $('#row_counter').html();
	...
	if(form_action == 'http://127.0.0.1:8000/updateUserByusManager'){	
	 var x = 0;
	}
	else{
		x = 1;
