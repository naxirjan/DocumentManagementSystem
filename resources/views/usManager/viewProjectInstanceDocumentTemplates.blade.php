...
{!!Form::open(array("url"=>"/usManager/assignDocumentTemplatesToProjectInstance","method"=>"post","role"=>"form", "name"=>"assignDocumentTemplates", "id"=>"assignDocumentTemplates", "enctype"=>"multipart/form-data"))!!}
                ...
                <div class="widget-main document_templates document_templates_searchable"> 
                    ...
                    <div class="widget-header widget-header-small add_document_template_component ui-draggable ui-draggable-handle"   document_template_id="{{$document_template['document_template_id']}}" style="border:1px solid #f1eded;margin-top:5px" document_template="{{$document_template['document_template_title']}}">   
                        ...
                        <div class="widget-toolbar">
                            <a target="_blank" href="/usManager/viewTemplateDetail/{{$document_template['document_template_id']}}" title="View Details">
            ...
            <ul class="nav nav-tabs padding-12 tab-color-blue background-blue" id="myTab4">
                ...
                <li class="country_tab <?php if($i==0){echo 'active';}?>">
                    <a data-toggle="tab" href="#country_{{$country['project_instance_assigned_id']}}" aria-expanded="<?php if($i==0){echo 'true';}else{echo 'false';}?>">
                       <?php 
                            $country_name = getCountryNameByCountryId($country['country_id']);
                            $country = strtolower($country_name[0]->cont_name);
                        ?>
                           
                            <img alt="" src='{{asset("storage/countires_icons/$country.png")}}'>
                            <b> {{ $country_name[0]->cont_name }}</b> 
                    ...
                    <div style="padding:10px;border-radius:10px;border:1px solid #c7c3c3;" class="document_template_already_exists" document_template_id="{{$document_template->document_template_id}}" template_type_id="{{$document_template->template_type_id}}">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                ...
                                <p class="pull-right"><u><b><a href="">Submissions: {{countTotalProjectInstanceDocumentTemplateSubmissions($document_template->project_instance_document_template_id,$country['project_instance_assigned_id'])}}</a></b></u></p>
...
@else
    <div class="col-md-3">
     ...
     <div class="col-md-8">
        ...
        <br/><br/> 
         <a href="/usManager/viewProjectInstances" class="btn btn-secondary"><i class="fa fa-arrow"></i> Back</a>
    </div>
@endif
    ...
    jQuery('.country_tab_section.tab-pane').droppable({
        ...
        drop: function(event, ui)
        {
            ...
            if (!ui.draggable.hasClass("dropped"))
            {
                ...
                {    
                    var content=null;
                    $.get("/usManager/loadProjectInstanceDocumentTemplateContent/" + document_template_id + "_" + project_instance_assigned_id, function(data)
                    {
                        content = data;
