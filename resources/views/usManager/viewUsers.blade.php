						...
						<tr>
							...
							<td class="text-center">
								<div class="hidden-sm hidden-xs action-buttons">
									<a target="_blank" title="View User Detail" class="green" href="/usManager/profile/{{Crypt::encryptString($user['user_id'])}}">
										<i class="ace-icon fa fa-search-plus bigger-150"></i>
									</a>

									<a target="_blank" title="Edit User" class="red" href="/usManager/editUser/{{$user['user_id']}}">
								...
								<div class="hidden-md hidden-lg">
									<div class="inline pos-rel">
										...
										<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
											<li>
                                                <a target="_blank" href="/usManager/profile/{{Crypt::encryptString($user['user_id'])}}" class="tooltip-info" data-rel="tooltip" title="View user Detail">
                                                    <span class="blue">
											...
											<li>
                                                <a target="_blank" href="/usManager/editUser/{{$user['user_id']}}" class="tooltip-success" data-rel="tooltip" title="Edit User">
                                                    <span class="green">
