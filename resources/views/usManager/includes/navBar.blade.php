				...
				<div class="navbar-header pull-left">
					...
					<a href="#" class="navbar-brand">
						<small>
							...
							Hidaya Trust - Project Document Management System
						</small>
					</a>
					...
					<ul class="nav ace-nav">
							...
							<ul class="dropdown-menu-right dropdown-navbar dropdown-menu dropdown-caret dropdown-close">
								...
								<li class="dropdown-content">
									<ul class="dropdown-menu dropdown-navbar">
										...
										<li>
											<a href="#" class="clearfix">
												<img src="{{asset('../assets/avatars/avatar2.png')}}" class="msg-photo" alt="Kate's Avatar" />
												<span class="msg-body">
													<span class="msg-title">
										...
										<li>
											<a href="#" class="clearfix">
												<img src="{{asset('../assets/avatars/avatar5.png')}}" class="msg-photo" alt="Fred's Avatar" />
												<span class="msg-body">
													<span class="msg-title">
						...
						<li class="light-blue">
							<a data-toggle="dropdown" href="#" class="dropdown-toggle">
								<img class="nav-user-photo" src="{{asset('storage/userImage/'.Auth::user()->image)}}" alt="Jason's Photo" />
