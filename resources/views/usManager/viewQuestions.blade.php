                    ...
                    @forelse($questions as $question)
                        ...
                        <tr>
                            ...
                            <td class="text-center">
								...
								<a title="View Question Detail" target="_blank" class="green" href="/usManager/viewQuestionDetail/{{$question->question_id}}">
									<i class="ace-icon fa fa-search-plus bigger-150"></i>
								</a>

								<a title="Edit Question" target="_blank" class="red" href="/usManager/editQuestion/{{$question->question_id}}">
							...
							<div class="hidden-md hidden-lg">
								<div class="inline pos-rel">
									...
									<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
										<li>
											<a target="_blank" href="/usManager/viewQuestionDetail/{{$question->question_id}}" class="tooltip-info" data-rel="tooltip" title="View Question Detail">
												<span class="green">
										...
										<li>
											<a target="_blank" href="/usManager/editQuestion/{{$question->question_id}}" class="tooltip-success" data-rel="tooltip" title="Edit Question">
												<span class="red">
