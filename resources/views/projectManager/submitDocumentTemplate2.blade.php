...
{!!Form::open(array("url"=>"/projectManager/submitDocumentTemplateProcess","method"=>"post","role"=>"form", "name"=>"submitDocumentTemplateProcess", "id"=>"submitDocumentTemplateProcess", "enctype"=>"multipart/form-data"))!!}
<div class="row">
...
@else
    <div class="col-md-3">
     ...
     <div class="col-md-8">
        ...
        <br/><br/> 
         <a href="/projectManager/viewProjectInstances" class="btn btn-secondary"><i class="fa fa-arrow"></i> Back</a>
    </div>
@endif
@endsection
...
$(document).ready(function(){
    ...
    $("#select_box_project_instance_document_template").change(function()
    {
        ...
        $("#project_instance_document_template_id").val(project_instance_document_template_id);
            /*jQuery Ajax*/
                $.ajax({
                url:'/projectManager/loadProjectInstanceDocumentTemplateSectionQuestions/'+project_instance_document_template_id,
                type:"POST",
                data:{
                    _token:'{{csrf_token()}}',
                    },
