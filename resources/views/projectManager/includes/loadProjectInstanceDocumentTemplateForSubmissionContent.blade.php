<div> 
        @if(is_numeric($project_instance_submission_status) && $project_instance_submission_status==0)
            <label class="hidden get_project_instance_document_status">
                <span class="label label-lg arrowed-in arrowed-in-right label-warning">Saved By: <b>{{$full_name_submitted_by}}</b></span>
            </label>    
        @elseif($project_instance_submission_status==1)
            <label class="hidden get_project_instance_document_status">
                <span class="label label-lg arrowed-in arrowed-in-right label-info">Submitted By: <b>{{$full_name_submitted_by}}</b></span>
            </label>
        @elseif($project_instance_submission_status==4)
           <label class="hidden get_project_instance_document_status">
                <span class="label label-lg arrowed-in arrowed-in-right label-info">Submitted By: <b>{{$full_name_submitted_by}}</b></span>
                <br />
                <span class="label label-lg arrowed-in arrowed-in-right label-success" style="margin-top: 5px;">Approved By Country Manager</span>
            </label>
        @elseif($project_instance_submission_status==5)
        <label class="hidden get_project_instance_document_status">
               <span class="label label-lg arrowed-in arrowed-in-right label-info">Submitted By: <b>{{$full_name_submitted_by}}</b></span>
                <br />
                <span class="label label-lg arrowed-in arrowed-in-right label-danger" style="margin-top: 5px;">UnApproved By Country Manager</span>
        </label>
         @elseif($project_instance_submission_status==6)
        <label class="hidden get_project_instance_document_status">
                <span class="label label-lg arrowed-in arrowed-in-right label-success ">Approved By Operation Manager</span>
        </label>
         @elseif($project_instance_submission_status==7)
        <label class="hidden get_project_instance_document_status">
                <span class="label label-lg arrowed-in arrowed-in-right label-danger ">UnApproved By Operation Manager</span>
        </label>
         @else
        <label class="hidden get_project_instance_document_status">
                <span class="label label-lg arrowed-in arrowed-in-right label-danger ">Record Not Found !...</span>
        </label>
        @endif

        @if(($project_instance_submission_status == 0 && $submitted_by ==session('current_role_user_id')) || $project_instance_submission_status==5 || $project_instance_submission_status==7) 
