<div> 
        ...
        @elseif($project_instance_submission_status==6)
           <label class="hidden get_project_instance_document_status">
                <span class="label label-lg label-success arrowed-in arrowed-in-right">Approved By Operation Manager</span>
            </label>
        @elseif($project_instance_submission_status==7)
        <label class="hidden get_project_instance_document_status">
                <span class="label label-lg label-danger arrowed-in arrowed-in-right">UnApproved By Operation Manager</span>
        </label>
        @endif

        @if($project_instance_submission_status==0 || $project_instance_submission_status==7)
            <div class="tabbable">
