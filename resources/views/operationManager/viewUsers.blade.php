						...
						<tbody>
							...
							<tr>
								<!-- 	<td class="center">
									...
									<td ><img style="width:50px;height:50px" src = "{{asset('storage/UserImage/'.$user['image'])}}" class = "img-circle"></td>
									<td>
										{{$user['first_name']}}
									</td>
									...
									<td class="text-center">
										<div class="hidden-sm hidden-xs action-buttons">
											<a target="_blank" title="View Users" class="green" href="/operationManager/profile/{{Crypt::encryptString($user['user_id'])}}">
												<i class="ace-icon fa fa-search-plus bigger-150"></i>
											</a>

											<a target="_blank" title="Edit User" class="red" href="/operationManager/editUser/{{$user['user_id']}}">
										...
										<div class="hidden-md hidden-lg">
											<div class="inline pos-rel">
												...
												<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
													<li>
														<a target="_blank" href="#" class="tooltip-info" data-rel="tooltip" title="View Users">
															<span class="blue">
													...
													<li>
														<a target="_blank" href="/operationManager/editUser/{{$user['user_id']}}" class="tooltip-success" data-rel="tooltip" title="Edit User">
															<span class="green">
