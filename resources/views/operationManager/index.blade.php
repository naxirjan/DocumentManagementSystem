...
<h1>
	Operation Manager Dashboard <span class="label label-lg label-primary arrowed-in arrowed-in-right"><i class="ace-icon fa fa-circle light-green bigger-10"></i> {{Session::get('current_cont_name')." (".Session::get('current_dop_name').")"}}</span>
	<!-- <small>
		...
		<div class="col-xs-6 col-sm-4 col-md-4 pricing-box">
			<div class="widget-box widget-color-blue">
				...
				<div class="widget-body">
					...
					<div>
						<a href="{{url('operationManager/submitDocumentTemplate').'/'.$project_instance_id}}" class="btn btn-block btn-primary">
