    ...
    <div class="col-md-12">
        ...
        <div class="form-horizontal">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-3 set_project_instance_document_status" style="padding-top:5px"></div>
            </div>
            <!--Status-->
        </div>
    </div>
...
{!!Form::open(array("url"=>"/partnerManager/submitDocumentTemplateProcess","method"=>"post","role"=>"form", "name"=>"submitDocumentTemplateProcess", "id"=>"submitDocumentTemplateProcess", "enctype"=>"multipart/form-data"))!!}
<div class="row">
...
@else
    <div class="col-md-3">
     ...
     <div class="col-md-8">
        ...
        <br/><br/> 
         <a href="/partnerManager/viewProjectInstances" class="btn btn-secondary"><i class="fa fa-arrow"></i> Back</a>
    </div>
@endif
   ...
   /*Document Templates Dropdown onChange*/
    $("#select_box_project_instance_document_template").change(function()
    {
        ...
        $("#project_instance_document_template_id").val(project_instance_document_template_id);
            /*jQuery Ajax*/
            $.ajax({
                url:'/partnerManager/loadProjectInstanceDocumentTemplateSectionQuestions/'+project_instance_document_template_id,
                type:"POST",
                data:{
                    _token:'{{csrf_token()}}',
                    },
                success:function(data)
                {
                    ...
                    $(".set_project_instance_document_status").removeClass('hidden').html($(".get_project_instance_document_status").html()); 
    ...
    /*Remove Old File Attachment Control*/
     ...
     /*Dialog Box Delete Old File Attachment*/
        $("#btn-delete-project_instance_submission_attachment").click(function(e)
        {
            ...
            /*jQuery Ajax*/
            $.ajax({
                url:'/partnerManager/deleteProjectInstanceSubmissionAttachment',
                type:"POST",
                data:{
                    _token:'{{csrf_token()}}',
    ...
    {
        $.get("/partnerManager/loadFileAttachmentControlContent", function( content ) 
        {
